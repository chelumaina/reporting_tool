		...
		children: [
			...
			},
			{
				...
				children: [
					...
					{
						id: 'scope-product-counties',
						title: 'Product Detail',
						type: 'item',
						url: '/apps/scope/counties/1/a-walk-amongst-friends-canvas-print',
						exact: true
					},
					{
						id: 'scope-new-counties',
						title: 'New Product',
						type: 'item',
						url: '/apps/scope/counties/new',
						exact: true
					},
					{
						id: 'scope-orders',
